...
public class Admin_Auction_Paging {
	...
	public Admin_Auction_Paging() { }
	
	// 총 게시글 수만 입력하는 생성자
	//	curPage == 1
	//	pageCount == 10
	//	listCount == 10
	public Admin_Auction_Paging(int totalCount) {
	...
	//	pageCount == 10
	//	listCount == 10
	public Admin_Auction_Paging(int totalCount, int curPage) {
		this(totalCount);
	...
	//	listCount == 10
	public Admin_Auction_Paging(int totalCount, int curPage, int listCount) {
	...
	//	listCount == 10
	public Admin_Auction_Paging(int totalCount, int curPage, int listCount, int pageCount) {
